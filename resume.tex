...
French Core curriculum in science and technology with honours (Singapore), September 2004 - June 2006
...
RUBY ON RAILS DEVELOPER (INTERNSHIP) - Safecoms, Bangkok, Thailand \\ 
...
UNITY DEVELOPER (INTERNSHIP) - Lumai Prod, Bangkok, Thailand \\ 
...
\vspace{0.05in}
 \begin{itemize} \itemsep -2pt
  \item November 2012: PHPTour event in Nantes, France\footnote{FuelPHP conference's audio recording: http://youtu.be/TbIFqYwz-SI (french)}
  \item July 2012: Libre Software Meeting event in Geneva, Switzerland\footnote{FuelPHP conference's video recording: http://youtu.be/BbmZiJpTGSY (french)}.
\end{itemize} 
...
\section{HOBBIES AND MISCELLANEOUS} 
 
Travels:
\vspace{0.05in}
 \begin{itemize} \itemsep -2pt
  \item Lived 6 years in Damascus, Syria
  \item Lived 3 years in Kuala Lumpur, Malaysia
  \item Lived 1 year in Bangkok, Thailand
  \item Visited more than 20 countries mainly in Asia and Europe
\end{itemize}
Open-source author and contributor\footnote{Github repositories: https://github.com/sdrdis (english)}. Most popular / important (more than 10 projects):
\vspace{0.05in}
 \begin{itemize} \itemsep -2pt
  \item Author of jquery.earth-3d: JQuery plugin that allows you to draw a beautiful 3d spinning earth on canvas\footnote{Presentation website: http://sebastien.drouyer.com/jquery.earth-3d/ (english)}
  \item Author of jquery.serialize-hash: JQuery plugin that returns a hash from serialization of a form\footnote{Github repository: https://github.com/sdrdis/jquery.serialize-hash (english)}
  \item jugglingdb (Nodejs ORM) core contributor\footnote{Presentation website: http://jugglingdb.co/ (english)}
\end{itemize}
Piano: 10 years, Lyon and Nice national conservatories of music \\
Bodybuilding\\
Bicycle
